...
define("_AM_PRINTLIMINATOR_HELP_IS_6" , "To create filecheck.txt, take the file <a href='../docs/md5.rar'>docs/md5.rar</a>, extract it to the root of the site and run it. The file filecheck.txt will be created at the root. Check it and if necessary remove './' at the beginning of the line. Then copy it to /modules/printliminator/admin with the old file replaced.<br />Using the link from the left, you need to generate the checksums of the file and add them to the /admin/md5parser.php file <br /><strong style='color:red;'>Attention:</strong> After using the script, do not forget to delete the script md5.php and file filecheck.txt from the root directory of your site!");
