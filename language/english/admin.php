...
define("_AM_INDEXSCAN_CHECKFORFILES","<tr class='header'><center><h2>Checking files for IFRAME Infection</h2></tr></center><center><small>Not that not all uses of Ifram is injections.<br>Check the code in the files found before you delete.<br></small></center>");
...
define('_AM_STARTUP_FORM_DESCRIPTION_1', 'After installing/enabling the module, you must set the <a href="../admin/xoopsinfo.php">"Printliminator" module in the XOOPS settings</a> as the default start page module.<br />Then you need to go to the module settings/installation and hide the module in the menu.');
