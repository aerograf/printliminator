...
define('_AM_STARTUP_FORM_DESCRIPTION_1', 'После установки, включения модуля необходимо установить в настройках XOOPS модуль "Printliminator" как модуль стартовой страницы по умолчанию.<br />Затем необходимо перейти в настройки/установку модуля и скрыть модуль в меню.');
