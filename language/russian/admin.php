...
define("_AM_PRINTLIMINATOR_QRCODE_DATA_ON",        "Блок 'QR Code' готов. Для настройки и активации перейдите в настройки блоков. Дополнительная информация по настройке в разделе помощи.");
define("_AM_PRINTLIMINATOR_QRCODE_DATA_OFF",        "Блок 'QR Code' не готов. Для включения блока необходимо разархивировать содержимое docs/data.rar в папку include. Должно получиться include/data. Далее следейте инструкциям.");
