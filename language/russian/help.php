...
define("_AM_PRINTLIMINATOR_HELP_FM_3" , "<p>В верхнем левом углу показан текущий путь.<br />Например, Вы можете видеть: <img src='" . XOOPS_URL . "/modules/printliminator/assets/images/icons/folder.png' style='vertical-align:middle; height:20px width:20px' />toto/aaaa/dfg.<br />Это сообщит Вам, где вы находитесь.<br />В этом примере указана текущая директория 'dfg'.<br />Чтобы вернуться в родительский каталог, щелкните его имя.</p><img src='" . XOOPS_URL . "/modules/printliminator/assets/images/icons/refresh.png' style='vertical-align:middle; height:20px width:20px' /> Чтобы перезагрузить и обновить страницу, нажмите на эту иконку.<br /><p><img src='" . XOOPS_URL . "/modules/printliminator/assets/images/icons/help.png' style='vertical-align:middle; height:20px width:20px' /> Эта иконка является ссылкой на этот документ.</p><img src='" . XOOPS_URL . "/modules/printliminator/assets/images/icons/disconnect.png' style='vertical-align:middle; height:20px width:20px' /> Если вы хотите выйти из системы, нажмите на нее. Ваш сеанс будет удален, и вы будете перенаправлены на страницу по умолчанию.");
